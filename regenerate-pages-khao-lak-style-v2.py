...
{features_html}
    ...
    <!-- Footer -->
    <footer class="footer" style="background: #2C2C2C; color: #fff; padding: 3rem 0 1rem;">
        <div class="container">
            <div class="footer-content" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 2rem; margin-bottom: 2rem;">
                <div class="footer-section">
                    <h3 style="color: #C9A96E; margin-bottom: 1rem;">SUNSHINE TOURS</h3>
                    <p>프리미엄 허니문 전문 여행사</p>
                ...
                <div class="footer-section">
                    <h4 style="color: #C9A96E; margin-bottom: 1rem;">여행지</h4>
                    <ul style="list-style: none; padding: 0;">
                        <li style="margin-bottom: 0.5rem;"><a href="/index.html#destinations" style="color: #fff; text-decoration: none;">태국</a></li>
                        <li style="margin-bottom: 0.5rem;"><a href="/index.html#destinations" style="color: #fff; text-decoration: none;">하와이</a></li>
                        <li style="margin-bottom: 0.5rem;"><a href="/index.html#destinations" style="color: #fff; text-decoration: none;">인도네시아</a></li>
                        <li style="margin-bottom: 0.5rem;"><a href="/index.html#destinations" style="color: #fff; text-decoration: none;">남태평양</a></li>
                    </ul>
                </div>
                <div class="footer-section">
                    <h4 style="color: #C9A96E; margin-bottom: 1rem;">고객센터</h4>
                    <ul style="list-style: none; padding: 0;">
                        <li style="margin-bottom: 0.5rem;"><a href="/inquiry.html" style="color: #fff; text-decoration: none;">문의하기</a></li>
                        <li style="margin-bottom: 0.5rem;"><a href="/reviews.html" style="color: #fff; text-decoration: none;">이용후기</a></li>
                        <li style="margin-bottom: 0.5rem;"><a href="/admin.html" style="color: #fff; text-decoration: none;">관리자</a></li>
                    </ul>
                </div>
                <div class="footer-section">
                    <h4 style="color: #C9A96E; margin-bottom: 1rem;">연락처</h4>
            ...
            <div class="footer-bottom" style="text-align: center; padding-top: 2rem; border-top: 1px solid rgba(255,255,255,0.1);">
